<?php
//send_email.php
$email_from = "Kontakt@domain.de";   //Absender falls keiner angegeben wurde
$sendermail_antwort = true;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "Email";   //Feld in der die Absenderadresse steht
 
$empfaenger = "info@thomniso.de"; //Empfänger-Adresse
$mail_cc = "nikolai.engelhardt@outlook.de"; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Neue Kontaktanfrage"; //Betreff der Email
 
$url_ok = "ok.html"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
